...
def main(config):
    ...
    videos_dir = '/data/user/xxx/DRLMF/wide_angle_video_frame'   #frame_path
    frame_dir = '/data/user/xxx/DRLMF/wide_angle_video_1frame'   #four_split_path
    feature_dir = '/data/user/xxx/SimpleVQA-main/videomeav2_wide_angle_video_feature'
    datainfo_train = '/data/dataset/MWV_train.csv'
    datainfo_test = '/data/dataset/MWV_test.csv'
    ...
    trainset = wide_VideoDataset_images_with_motion_features_and_deformation(videos_dir, frame_dir, feature_dir, datainfo_train,
                                                             ...
                                                             'wide_angle_video_train', config.crop_size, 'tad')
    testset =wide_VideoDataset_images_with_motion_features_and_deformation(videos_dir, frame_dir, feature_dir, datainfo_test,
                                                            ...
                                                            'wide_angle_video_test', config.crop_size, 'tad')
...
if __name__ == '__main__':
    ...
    # input parameters
    parser.add_argument('--database', type=str, default='wide_angle_video')  # LSVQ
