...
def main(config):
    ...
    frame_dir = '/data/user/gbb/SimpleVQA/konvid1k_image_all_fps1_motion_4kuai'
    feature_dir = '/data/user/zhaoyimeng/VideoMAEv2-master/save_feat/KoNViD_1k_VideoMAE_feat'
    datainfo_train = '/data/user/zhaoyimeng/ModularBVQA/data/KoNViD-1k_data.mat'
    datainfo_test = '/data/user/zhaoyimeng/ModularBVQA/data/KoNViD-1k_data.mat'
    ...
    trainset = wide_VideoDataset_images_with_motion_features_and_deformation(videos_dir, frame_dir, feature_dir, datainfo_train,
                                                             ...
                                                             'KoNViD-1k_train', config.crop_size, 'tad_konvid')
    testset =wide_VideoDataset_images_with_motion_features_and_deformation(videos_dir, frame_dir, feature_dir, datainfo_test,
                                                            ...
                                                            'KoNViD-1k_test', config.crop_size, 'tad_konvid')
...
if __name__ == '__main__':
    ...
    # input parameters
    parser.add_argument('--database', type=str, default='Konvid')  # LSVQ
    ...
    parser.add_argument('--trained_model', type=str,
                        default='/data/user/gbb/SimpleVQA-main/ckpts/DRSMF_LSVQ_plcc_NR_v0_epoch_80_SRCC_0.887008.pth')
    # misc
