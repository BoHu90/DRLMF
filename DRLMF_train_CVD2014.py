...
def main(config):
    ...
    videos_dir = '/data/user/XXX/data/cvd2014_image_all_fps1'
    frame_dir = '/data/user/XXX/cvd2014_all_fps1_motion_4kuai'
    feature_dir = '/data/user/XXX/VideoMAEv2-master/save_feat/CVD204_VideoMAE_feat'
    datainfo_train = '/data/user/XXX/data/CVD2014_Realignment_MOS.csv'
    datainfo_test = '/data/user/XXX/data/CVD2014_Realignment_MOS.csv'
    ...
    trainset = wide_VideoDataset_images_with_motion_features_and_deformation(videos_dir, frame_dir, feature_dir, datainfo_train,
                                                             ...
                                                             'CVD2014_train', config.crop_size, 'tad_CVD2014')
    testset =wide_VideoDataset_images_with_motion_features_and_deformation(videos_dir, frame_dir, feature_dir, datainfo_test,
                                                            ...
                                                            'CVD2014_test', config.crop_size, 'tad_CVD2014')
...
if __name__ == '__main__':
    ...
    # input parameters
    parser.add_argument('--database', type=str, default='cvd')  # LSVQ
