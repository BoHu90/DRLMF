...
def get_args():
    ...
    parser.add_argument(
        '--data_path',
        default='/data/dataset/wide_angle_video/',
        type=str,
        help='dataset path')
    parser.add_argument(
        '--save_path',
        default='/data/user/gbb/SimpleVQA-main/videomeav2_wide_angle_video_feature',
        type=str,
...
def extract_feature(args):
    ...
    for idx, vid_name in enumerate(vid_list):
        ...
        if dataset == 'wide_angle_video' or dataset == 'LSVQ_train' or dataset == 'LSVQ_test' or dataset == 'LSVQ_test_1080p':
